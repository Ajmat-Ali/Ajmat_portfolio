export const JOURNEY = {
  index: "04. Experience & Trajectory",
  title: " My Journey",
  description:
    "A clear timeline of foundational computer science studies, full-stack MERN engineering, and current algorithmic development.",
  journeyTimeline: [
    {
      period: "2024 — Present",
      title: "DSA & AWS",
